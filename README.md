...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/kitty-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/kitty-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
It is possible to list all of the versions of `kitty` available on your platform:
...
```
pixi search kitty --channel conda-forge
```
